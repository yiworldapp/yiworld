        ...
        <div className="space-y-4">
          ...
          <div className="rounded-xl border border-border p-5 space-y-3">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-sm font-medium">{format(new Date(event.starts_at), 'EEEE, MMM d, yyyy')}</p>
            ...
            {event.ends_at && new Date(event.ends_at).toDateString() !== new Date(event.starts_at).toDateString() && (
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium">{format(new Date(event.ends_at), 'EEEE, MMM d, yyyy')}</p>
                </div>
              </div>
            )}
          </div>
